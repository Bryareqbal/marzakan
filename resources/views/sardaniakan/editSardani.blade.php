        ...
        <div class="mx-auto mt-6 max-w-7xl space-y-5">
            <div
                ...
                <div class="flex basis-full flex-col space-y-5 self-start">
                    {{-- <form action="{{ route('update-sardani', ['sardani' => $sardani->id]) }}" method="post"
                        enctype="multipart/form-data">
                        <div class="flex flex-col items-start">
                            <div>
                                <x-input placeholder="گەڕان...(ژمارەی پاسپۆرت)" name="search" class="min-w-[20rem]"
                                    value="{{ old('search', $sardani->search) }}" />
                    ...
                    @if ($sardani->sardanikar)
                        <div>
                            <div class="mx-auto w-[15rem]">
                                <label for="img">
                                    <img src="{{ Storage::url($sardani->sardanikar->img) }}"
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                            ...
                                            <x-input disabled name="nickname" id="nickname" type="text"
                                                ...
                                                value="{{ $sardani->sardanikar->nickname }}" />
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                            ...
                                            <x-input disabled name="passport_number" id="passport_number" type="text"
                                                ...
                                                value="{{ $sardani->sardanikar->passport_number }}" />
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                            ...
                                            <x-input disabled name="birth_date" id="birth_date" type="date"
                                                class="w-full rounded-lg border border-slate-300 py-2 pr-3"
                                                value="{{ $sardani->sardanikar->birth_date }}" />
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                            ...
                                            <x-select name="gender" id="gender" disabled>
                                                <option value="{{ 1 }}" @selected($sardani->sardanikar->gender === true)>نێر
                                                </option>
                                                <option value="{{ 0 }}" @selected($sardani->sardanikar->gender === false)>مێ
                                                </option>
                                            </x-select>
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                            ...
                                            <x-input disabled name="nation" id="nation" type="text"
                                                class="w-full rounded-lg border border-slate-300 py-2 pr-3"
                                                value="{{ $sardani->sardanikar->nation ?? 'IRAN' }}" />
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                            ...
                                            <x-input disabled name="passport_expire_date" id="passport_expire_date"
                                                ...
                                                value="{{ $sardani->sardanikar->passport_expire_date }}" />
                                    ...
                                    <div class="flex flex-col space-y-3">
                                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                            ...
                                            <x-input disabled name="issuing_authority" id="issuing_authority" type="text"
                                                class="w-full rounded-lg border border-slate-300 py-2 pr-3"
                                                value="{{ $sardani->sardanikar->issuing_authority ?? 'IRAN' }}" />
                ...
                <form class="basis-full" action="{{ route('update-sardani', ['sardani' => $sardani->id]) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="flex flex-col space-y-3">
                            <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                ...
                                <x-input name="purpose_of_coming" id="purpose_of_coming" type="text"
                                    class="w-full rounded-lg border border-slate-300 py-2 pr-3"
                                    value="{{ old('purpose_of_coming', $sardani->purpose_of_coming) ?? 'سەردانیکردن' }}" />
                        ...
                        <div class="flex flex-col space-y-3">
                            <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                ...
                                <x-input name="address" id="address" type="text"
                                    class="w-full rounded-lg border border-slate-300 py-2 pr-3"
                                    value="{{ old('address', $sardani->address ?? 'سلێمانی') }}" />
                        ...
                        <div class="flex flex-col space-y-3">
                            <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                ...
                                <x-select name="status" id="status" type="date">
                                    ...
                                    <option value="coming" @selected(old('status', $sardani->status) === 'coming')>هاتن</option>
                                    <option value="leaving" @selected(old('status', $sardani->status) === 'leaving')>ڕۆشتن</option>
                                </x-select>
                        ...
                        <div class="flex flex-col space-y-3">
                            <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                ...
                                <x-select name="mount_of_money" id="mount_of_money">
                                    <option value="{{ 5000 }}" @selected(old('mount_of_money', $sardani->mount_of_money) == 5000) selected>5,000
                                    </option>
                                    <option value="{{ 10000 }}" @selected(old('mount_of_money', $sardani->mount_of_money) == 10000)>10,000</option>
                                    <option value="free" @selected(!empty(old('mount_of_money', $sardani->mount_of_money)) && old('mount_of_money', $sardani->mount_of_money) == 'free')>بێبەرامبەر
                                    </option>
                                </x-select>
                        ...
                        <div class="flex flex-col space-y-3">
                            <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                ...
                                <x-input name="targeted_person" id="targeted_person" type="text"
                                    class="w-full rounded-lg border border-slate-300 py-2 pr-3"
                                    value="{{ old('targeted_person', $sardani->targeted_person) }}" />
                        ...
                        <div class="flex flex-col space-y-3">
                            <fieldset class="rounded-lg border-2 border-green-500 p-2">
                                ...
                                <x-input name="no_of_visitors" id="no_of_visitors" type="text"
                                    class="w-full rounded-lg border border-slate-300 py-2 pr-3"
                                    value="{{ old('no_of_visitors', $sardani->no_of_visitors ?? '07') }}" />
