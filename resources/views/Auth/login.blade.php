                ...
                <div class="mt-12 space-y-6">
                    <div class="relative flex flex-col">
                        <input type="text" id="username" name="username"
                            class="peer w-full placeholder:font-sans border-b-2 border-slate-300 py-2 placeholder-transparent focus:border-emerald-500 focus:outline-none"
                            placeholder="ناوی بەکارهێنەر" value="{{ old('username') }}">
                        <label for="username"
                            class="absolute left-0 -top-3.5 capitalize text-slate-700 transition-all duration-200 peer-placeholder-shown:top-2 peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-focus:-top-3.5 peer-focus:text-slate-600">ناوی
                            بەکارهێنەر</label>
                        <x-error message="username" />
                    </div>
                    <div class="relative flex flex-col">
                        <input type="password" id="password" name="password"
                            class="peer w-full border-b-2 border-slate-300 py-2 placeholder-transparent focus:border-emerald-500 focus:outline-none"
                            placeholder="وشەی نهێنی">
                        <label for="password"
                            class="absolute -top-2.5 left-0 capitalize transition-all duration-200 peer-placeholder-shown:top-1 peer-placeholder-shown:text-base peer-placeholder-shown:text-slate-400 peer-focus:-top-2.5 peer-focus:text-slate-600">وشەی
                            نهێنی</label>
