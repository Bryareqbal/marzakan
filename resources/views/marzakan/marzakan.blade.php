...
@section('content')
    <div class="container mx-auto pt-10">
        <section class="flex justify-center">
            <button class="flex items-center space-x-3 space-x-reverse rounded-lg bg-white py-2 px-2">
                    ...
                    <div class="flex flex-col space-y-3">
                        <fieldset class="rounded-lg border-2 border-green-500 p-2">
                            ...
                            <x-input name="name" id="name" type="text"
                                class="w-full rounded-lg border border-slate-300 pr-3 shadow-2xl" />
                        </fieldset>
