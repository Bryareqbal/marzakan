...
@section('content')
    ...
    <div class="container mx-auto mt-10 px-3">
        <div class="grid grid-flow-row grid-cols-1 grid-rows-4 gap-4 md:grid-cols-2 lg:grid-cols-4 2xl:grid-cols-4">
            ...
            @endcan
            @canany(['user'])
                <x-card route="sardaniakan" label="سەردانییەکان" :count="$countSardanikar">
            ...
            @endcanany
            @canany(['superadmin'])
                <x-card route="show-sardanikaran" label="سەردانیکەران">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="h-6 w-6 text-emerald-500">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            @endcanany
            @canany(['summary', 'superadmin', 'sarparshtyar'])
                        ...
                        <div class="flex items-center">
                            <p class="flex h-10 w-10 items-center justify-center rounded-xl bg-rose-200">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="h-6 w-6 rotate-180 text-red-500">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" />
                                </svg>
                            </p>
                            <ul class="mr-3 flex flex-col items-end justify-end">
